...
urlpatterns = [
    ...
    path('notes_detail/<str:pk>/',views.NotesDetailView.as_view(),name="notes-details"),
    ...
    path('logged_out/', TemplateView.as_view(template_name="dashboard/logout.html"), name='logged_out'),
